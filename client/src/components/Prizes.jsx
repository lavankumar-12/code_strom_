...
const Prizes = () => {
    return (
        <section id="prizes" className="py-16 md:py-24 relative overflow-hidden">
            {/* Dynamic Background */}
            ...
            <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
                ...
                >
                    ...
                    >
                        <span className="text-3xl md:text-5xl font-bold text-yellow-400 tracking-wider">₹ 1,00,000</span>
                    </motion.div>
                </motion.div>

...
const tracks = [
    { icon: FaBrain, title: 'Generative AI & LLM', desc: 'Next-gen AI applications', color: 'border-purple-500' },
    { icon: FaRobot, title: 'Robotics & Drones', desc: 'Autonomous systems', color: 'border-blue-500' },
    { icon: FaShieldAlt, title: 'Cybersecurity', desc: 'Threat intelligence & trust', color: 'border-red-500' },
    { icon: FaHeartbeat, title: 'HealthTech', desc: 'MedAI & Diagnostics', color: 'border-pink-500' },
    { icon: FaBitcoin, title: 'FinTech', desc: 'Blockchain & Digital Trust', color: 'border-yellow-500' },
    { icon: FaCity, title: 'Smart Cities', desc: 'IoT & Edge Computing', color: 'border-cyan-500' },
    { icon: FaLeaf, title: 'Green Tech', desc: 'Energy Optimization', color: 'border-green-500' },
    { icon: FaTractor, title: 'Agritech', desc: 'Rural Innovation', color: 'border-lime-500' },
    { icon: FaCar, title: 'Transportation', desc: 'AI-Driven Logistics', color: 'border-indigo-500' },
    { icon: FaLightbulb, title: 'Open Innovation', desc: 'Wildcard Track', color: 'border-white' },
];
                    ...
                    {tracks.map((track, index) => (
                        ...
                        >
                            <div className="p-5 rounded-full bg-white/5 mb-6 group-hover:bg-white/10 transition-colors duration-300 relative z-10 group-hover:scale-110 ease-in-out">
                                <track.icon size={32} className="text-gray-300 group-hover:text-white transition-colors duration-300" />
                            </div>
